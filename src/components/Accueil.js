function Accueil() {
    return (
        <div>
            <h1 className="font-bold text-center ">Développeur full-stack</h1>
            <div class=" m-20">
                <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg">
                    ...
                    <div class="p-6 flex flex-col justify-start">
                        <h5 class="text-gray-900 text-xl font-medium mb-2 ">Christophe heddebaut</h5>
                        <div class="flex flex-col md:flex-row">
                            <svg class="h-8 w-8 text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                            </svg> <div class="mt-1 ml-1">Coordonnée</div>
                        </div>
                        ...
                        </svg> <div class="mt-1 ml-1">Téléphone</div>
                        </div>
                        <p class="text-gray-600 text-xs">06.03.06.41.46</p>
                    </div>
                </div>
            </div>
            <div className=" ml-96">
